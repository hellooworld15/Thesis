...
\begin{itemize}
    ...
    %In the case of a straight tapered wing with a taper ratio (\acrshort{lambda}), the \acrshort{MAC} equation can be simplified to Equation \ref{eqn:MACSimplified}.
...
%In this phenomenon, at high Mach numbers ($>$ 0.8), a sharp discontinuity of pressure is seen in a narrow region travelling through a medium. 
...
\subsection{LVLH Axes: denoted as \texorpdfstring{($x_v$, $y_v$, $z_v$)}{L}}
