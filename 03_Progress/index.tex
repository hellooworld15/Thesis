...
A current example of this is again the GenMAV model created for ??? testing \todo{cite GenMAV}. The shape of this design however is optimized for testing and in doing so loses a typical streamlined fuselage shape. \\

%Add image of the model

Due to the complexity of the wing shape and airfoil, the main wing was modelled in VSP software and based on a model of the nanotalon \cite{} \todo{nanotalon}. This wing design was chosen due to its generic wing shape and simple design. The main geometry of the current model is given in Figure \ref{fig:model1}.
