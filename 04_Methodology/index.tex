...
\section{VAP 3.5}
VAP 3.5 is a open-source software which uses the High-Order Free Wake (\acrshort{HOFW}) method in order to determine the aerodynamic performace of MAV designs. \\
